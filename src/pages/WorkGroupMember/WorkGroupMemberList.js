...
// 需要动态生成。
@Form.create()
class WorkGroupMemberList extends PureComponent {
  state = {
    expandForm: false,
    selectedRows: [],
    formValues: {},
   ...
   */
  previewItem = id => {
    router.push(`/workGroupMember/workGroupMemberForm/${id}`);
  };
  newItem = () => {
    router.push(`/workGroupMember/workGroupMemberForm`);
  };
...
export default WorkGroupMemberList;