...
@connect(({ _routine, loading }) => {
  return {
    _routine,
    loading: loading.models._routine,
  };
})

// 需要动态生成。
@Form.create()
class RoutineList extends PureComponent {
  state = {
    expandForm: false,
    selectedRows: [],
    formValues: {},
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label="日常活动类型">
              {getFieldDecorator('routineType')(<Input placeholder="请输入" />)}
            </FormItem>
          </Col>       
        </Row>
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          <Col md={8} sm={24}>
            <FormItem label="日常活动内容">
        ...
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label="活动截止日期">
              {getFieldDecorator('endTime')(<Input placeholder="请输入" />)}
            </FormItem>
          </Col>       
          <Col md={8} sm={24}>
            <FormItem label="活动是否截止">
              {getFieldDecorator('end')(<Input placeholder="请输入" />)}
            </FormItem>
          </Col>       
        </Row>
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label="可见范围">
              {getFieldDecorator('visibility')(<Input placeholder="请输入" />)}
            </FormItem>
          </Col>       
          <Col md={8} sm={24}>
