...
@connect(({ _banner, loading }) => ({
  _banner,
  submitting: loading.effects['_banner/add'],
}))
@Form.create()
            ...
            <FormItem>
              {
                getFieldDecorator('bannerId', {
                  initialValue: object.bannerId
                })(<Input type='hidden' placeholder='' />)
              }
            </FormItem>  
            <FormItem {...formItemLayout} label='图像地址'>
              {
                getFieldDecorator('bannerImageUrl', {
                  initialValue: object.bannerImageUrl
                })(<Input placeholder='' />)
              }
            </FormItem>
            <FormItem {...formItemLayout} label='横幅标题'>
              {
                getFieldDecorator('bannerTitle', {
                  initialValue: object.bannerTitle
                })(<Input placeholder='' />)
              }
            </FormItem>
            <FormItem>
