...
import { queryCollect, removeCollect, addCollect, updateCollect, queryById } from '../../../services/collect';
...
export default {
  ...
  effects: {
    ...
    *add({ payload, callback }, { call, put }) {
      const response = yield call(addCollect, payload);
      yield put({
        type: 'saveList',
        payload: response,
      });
    ...
    *remove({ payload, callback }, { call, put }) {
      const response = yield call(removeCollect, payload);
      yield put({
        type: 'saveList',
        payload: response,
      });
    ...
    *update({ payload, callback }, { call, put }) {
      const response = yield call(updateCollect, payload);
      yield put({
        type: 'saveList',
        payload: response,
      });
