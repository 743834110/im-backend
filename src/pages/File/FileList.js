...
class FileList extends PureComponent {
   ...
   */
  previewItem = id => {
    router.push(`/file/fileForm/${id}`);
  };
  newItem = () => {
    router.push(`/file/fileForm`);
  };
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          <Col md={8} sm={24}>
            <FormItem label="原文件名">
              {getFieldDecorator('originName')(<Input placeholder="请输入" />)}
            </FormItem>
          </Col>          
          <Col md={8} sm={24}>
            <FormItem label="文件大小(byte)">
              {getFieldDecorator('fileSize')(<Input placeholder="请输入" />)}
            </FormItem>
          </Col>          
          <Col md={8} sm={24}>
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        ...
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          <Col md={8} sm={24}>
            <FormItem label="业务ID">
              {getFieldDecorator('busiId')(<Input placeholder="请输入" />)}
            </FormItem>
          </Col>       
          <Col md={8} sm={24}>
            <FormItem label="业务表名称">
              {getFieldDecorator('compId')(<Input placeholder="请输入" />)}
            </FormItem>
          </Col>       
          <Col md={8} sm={24}>
            <FormItem label="mime类型">
              {getFieldDecorator('mimeType')(<Input placeholder="请输入" />)}
            </FormItem>
          </Col>       
        </Row>
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          <Col md={8} sm={24}>
            <FormItem label="创建者ID">
          ...
          <Col md={8} sm={24}>
            <FormItem label="文件相对路径">
              {getFieldDecorator('filePath')(<Input placeholder="请输入" />)}
            </FormItem>
          </Col>       
        </Row>
